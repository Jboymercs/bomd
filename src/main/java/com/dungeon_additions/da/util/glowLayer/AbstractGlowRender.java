...
public abstract class AbstractGlowRender<T extends EntityLivingBase & IAnimatable> extends GeoLayerRenderer<T> {
    ...
    public AbstractGlowRender(GeoEntityRenderer<T> renderer, Function<T, ResourceLocation> funcGetCurrentTexture, Function<T, ResourceLocation> funcGetCurrentModel) {
        super(renderer);
