...
public class ParticleGravitySpark extends ParticleSSBase{
    ...
    public ParticleGravitySpark(TextureManager textureManager, World world, double x, double y, double z, double movementX, double movementY, double movementZ, int color)
    {
        ...
        this.particleScale =  0.3F + (float) (Math.random() * 0.2F);
        this.setAlphaF(0.9F);
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new ParticleGravitySpark(Minecraft.getMinecraft().getTextureManager(), world, posX, posY, posZ, speedX, speedY, speedZ, parameters[0]); }
    }
