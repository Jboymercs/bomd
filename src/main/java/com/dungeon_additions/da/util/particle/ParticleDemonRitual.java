...
public class ParticleDemonRitual extends ParticleSSBase {
    private static final ResourceLocation PIXEL_TEXTURE = new ResourceLocation(ModReference.MOD_ID, "textures/particle/ritual_sigil.png");

    public ParticleDemonRitual(TextureManager textureManager, World world, double x, double y, double z, double movementX, double movementY, double movementZ)
    {
    ...
    public void onUpdate()
    {
        ...
        this.texSpot = Math.min(this.particleAge * 3 / (this.particleMaxAge), 3);
    }
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new ParticleDemonRitual(Minecraft.getMinecraft().getTextureManager(), world, posX, posY, posZ, speedX, speedY, speedZ); }
    }
}
