...
public class ParticleDauntlessSlice extends ParticleSSBase{

    //unused
    final Entity target;


    private static final ResourceLocation PIXEL_TEXTURE = new ResourceLocation(ModReference.MOD_ID, "textures/particle/dauntless_slice.png");
    public ParticleDauntlessSlice(TextureManager textureManager, World world, double x, double y, double z, double movementX, double movementY, double movementZ, Entity target)
    {
        ...
        this.texSheetSeg = 2;
        this.renderYOffset = this.height / 4;
    ...
    public void onUpdate()
    {
        ...
        if (target != null && target.isEntityAlive())
        {
            ...
            this.posY = target.posY + target.height + 0.3;
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        public Particle createParticle(int particleId, World world, double posX, double posY, double posZ, double speedX, double speedY, double speedZ, int... parameters)
        {
            ...
            return new ParticleDauntlessSlice(Minecraft.getMinecraft().getTextureManager(), world, posX, posY, posZ, speedX, speedY, speedZ,  target); }
    }
