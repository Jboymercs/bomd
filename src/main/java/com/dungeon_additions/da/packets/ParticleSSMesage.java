...
public class ParticleSSMesage implements IMessage
{
    ...
    public ParticleSSMesage() {}

    public ParticleSSMesage(int particleId, double posX, double posY, double posZ, double speedX, double speedY, double speedZ, int... parameters)
    {
    ...
    public static class Handler implements IMessageHandler<ParticleSSMesage, IMessage>
    {
        @Override
