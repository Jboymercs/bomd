...
/** This is used so the Server can tell Clients when the custom item Capability is altered, so animations are displayed. */
public class PacketSwingItem implements IMessage {
    private int entityId;
    private int duration;

    public PacketSwingItem() {}

    public PacketSwingItem(int entityId, int durationIn)
    {
    ...
    {
        @Override
        public IMessage onMessage(PacketSwingItem message, MessageContext ctx)
        {
