...
public class NetherArenaWarped {
    ...
    public NetherArenaWarped(World worldIn, TemplateManager template, List<StructureComponent> components) {
        this.world = worldIn;
    ...
    public void startVault(BlockPos pos, Rotation rot) {
        NetherArenaTemplate templateAdjusted = new NetherArenaTemplate(manager, "warped/arena/arena_1", pos, rot, 0, true);
    ...
    private boolean generateArena(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        NetherArenaTemplate arenaTwo = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(0,0,0),"warped/arena/arena_2", rot);
        NetherArenaTemplate arenaThree = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(-24,0,23), "warped/arena/arena_3", rot);
        NetherArenaTemplate arenaFour = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(0,0,23), "warped/arena/arena_4", rot);
    ...
    private boolean generateHold(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        String[] hold_types = {"warped/cross_1", "warped/cross_2", "warped/cross_2","warped/cross_3","warped/cross_3","warped/cross_4","warped/cross_5"};
    ...
    private boolean generateMiniBossRoom(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        NetherArenaTemplate hold = addAdjustedPiece(parent, pos, "warped/mini_boss_room", rot);
        if(hold.isCollidingExcParent(manager, parent, components)) {
            return false;
        }
    ...
    private boolean generateFloor(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        String[] big_rooms = {"warped/hold/floor_1", "warped/hold/floor_2", "warped/hold/floor_3", "warped/hold/floor_4", "warped/hold/floor_5"};
        String[] small_rooms = {"warped/hold/small_floor_1", "warped/hold/small_floor_2"};
