...
public class NetherArenaCrimson {
    ...
    public NetherArenaCrimson(World worldIn, TemplateManager template, List<StructureComponent> components) {
        this.world = worldIn;
    ...
    public void startVault(BlockPos pos, Rotation rot) {
        NetherArenaTemplate templateAdjusted = new NetherArenaTemplate(manager, "crimson/arena/arena_1", pos, rot, 0, true);
    ...
    private boolean generateArena(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        NetherArenaTemplate arenaTwo = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(0,0,0),"crimson/arena/arena_2", rot);
        NetherArenaTemplate arenaThree = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(-24,0,23), "crimson/arena/arena_3", rot);
        NetherArenaTemplate arenaFour = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(0,0,23), "crimson/arena/arena_4", rot);
    ...
    private boolean generateHold(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        String[] hold_types = {"crimson/cross_1", "crimson/cross_2", "crimson/cross_2","crimson/cross_3","crimson/cross_3","crimson/cross_4","crimson/cross_5"};
    ...
    private boolean generateMiniBossRoom(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        NetherArenaTemplate hold = addAdjustedPiece(parent, pos, "crimson/mini_boss_room", rot);
        if(hold.isCollidingExcParent(manager, parent, components)) {
            return false;
        }
    ...
    private boolean generateFloor(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        String[] big_rooms = {"crimson/hold/floor_1", "crimson/hold/floor_2", "crimson/hold/floor_3", "crimson/hold/floor_4", "crimson/hold/floor_5"};
        String[] small_rooms = {"crimson/hold/small_floor_1", "crimson/hold/small_floor_2"};
