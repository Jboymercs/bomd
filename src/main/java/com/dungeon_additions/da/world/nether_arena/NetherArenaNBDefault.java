...
public class NetherArenaNBDefault {
    ...
    public NetherArenaNBDefault(World worldIn, TemplateManager template, List<StructureComponent> components) {
        this.world = worldIn;
    ...
    public void startVault(BlockPos pos, Rotation rot) {
        NetherArenaTemplate templateAdjusted = new NetherArenaTemplate(manager, "default/arena/arena_1", pos, rot, 0, true);
    ...
    private boolean generateArena(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        NetherArenaTemplate arenaTwo = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(0,0,0),"default/arena/arena_2", rot);
        NetherArenaTemplate arenaThree = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(-24,0,23), "default/arena/arena_3", rot);
        NetherArenaTemplate arenaFour = addAdjustedPieceWithoutCount(parent, BlockPos.ORIGIN.add(0,0,23), "default/arena/arena_4", rot);
    ...
    private boolean generateHold(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        String[] hold_types = {"default/cross_1", "default/cross_2", "default/cross_2","default/cross_3","default/cross_3","default/cross_4","default/cross_5"};
    ...
    private boolean generateMiniBossRoom(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        NetherArenaTemplate hold = addAdjustedPiece(parent, pos, "default/mini_boss_room", rot);
        if(hold.isCollidingExcParent(manager, parent, components)) {
            return false;
        }
    ...
    private boolean generateFloor(NetherArenaTemplate parent, BlockPos pos, Rotation rot) {
        String[] big_rooms = {"default/hold/floor_1", "default/hold/floor_2", "default/hold/floor_3", "default/hold/floor_4", "default/hold/floor_5"};
        String[] small_rooms = {"default/hold/small_floor_1", "default/hold/small_floor_2"};
