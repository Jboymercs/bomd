...
public class NetherArenaTemplate extends ModStructureTemplate {
    ...
    private static final ResourceLocation LOOT = new ResourceLocation(ModReference.MOD_ID, WorldConfig.coins_spawn_in_chests ? "flame_arena_chests" : "flame_arena_chests_nc");
