...
public class LichTowerBase {
    ...
    public LichTowerBase(World worldIn, TemplateManager template, List<StructureComponent> components) {
        this.world = worldIn;
    ...
    public void startTower(BlockPos pos, Rotation rot) {
        LichTowerTemplate templateAdjusted = new LichTowerTemplate(manager, "tower_base_b", pos, rot, 0, true);
    ...
    public boolean generateSecondFloor(LichTowerTemplate parent, BlockPos pos, Rotation rot) {
        LichTowerTemplate second_floor = addAdjustedPiece(parent, BlockPos.ORIGIN.add(-27, 21, 0), "tower_middle_b", rot);
    ...
    public boolean generateTopFloor(LichTowerTemplate parent, BlockPos pos, Rotation rotation) {
        LichTowerTemplate top_floor = addAdjustedPiece(parent, BlockPos.ORIGIN.add(-27, 25,0), "tower_top_b", rotation);
