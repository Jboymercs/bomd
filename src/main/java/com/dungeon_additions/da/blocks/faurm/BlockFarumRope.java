...
public class BlockFarumRope extends BlockPillarBase {
    ...
    public BlockFarumRope(String name, Material materialIn, float hardness, float resistance, SoundType soundType) {
