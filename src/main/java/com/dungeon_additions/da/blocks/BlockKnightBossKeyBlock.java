...
public class BlockKnightBossKeyBlock extends BlockBase implements IBlockUpdater, ITileEntityProvider {
    ...
    public BlockKnightBossKeyBlock(String name, Item item, BiFunction<World, BlockPos, Entity> spawnPortal) {
