...
public class BlockAzealaVines extends BlockBush implements IHasModel, RegistryHandler.IStateMappedBlock {
    ...
    public static final PropertyBool IS_GLOW = PropertyBool.create("is_glow");
    ...
    public BlockAzealaVines(String name, Material materialIn) {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(IS_TOP, true).withProperty(IS_BOTTOM, false).withProperty(IS_GLOW, false).withProperty(CAN_GROW, true));
    }

    @Override
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, new IProperty[]{IS_TOP, IS_BOTTOM, IS_GLOW, CAN_GROW});
    }
    ...
    protected boolean isValidBlock(World world, BlockPos pos, IBlockState blockState) {
        return blockState.isSideSolid(world, pos, EnumFacing.DOWN) || blockState.getBlock() == this || blockState.getBlock() == ModBlocks.MOSS_BLOCK || blockState.getBlock() == Blocks.STONE;
    }
    ...
    public int getLightValue(IBlockState state, IBlockAccess world, BlockPos pos) {
        if(world.getBlockState(pos) == this.getDefaultState().withProperty(IS_GLOW, true)) {
            return 8;
        }
        return 0;
    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if(rand.nextInt(12) == 0 && worldIn.getBlockState(pos) != this.getDefaultState().withProperty(IS_BOTTOM, true)) {
            worldIn.setBlockState(pos, this.getDefaultState().withProperty(IS_GLOW, true));
        }
    }
    ...
    protected boolean canSustainBush(IBlockState state) {
        return state.getBlock() == ModBlocks.MOSS_BLOCK || state.getBlock() == Blocks.STONE;
    }
