...
public class BlockCoraliteLamp extends BlockBase {
    ...
    public BlockCoraliteLamp(String name, Material material) {
        super(name, material);
    }

    public BlockCoraliteLamp(String name, Material material, float hardness, float resistance, SoundType soundType) {
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (rand.nextInt(7) == 0) {
            Vec3d particlePos = new Vec3d(pos.getX() + 0.2 + ModRand.getFloat(10F), pos.getY() + ModRand.getFloat(3F), pos.getZ() + 0.2 + ModRand.getFloat(10F));
            Main.proxy.spawnParticle(23, worldIn, particlePos.x, particlePos.y, particlePos.z, worldIn.rand.nextFloat()/3 - worldIn.rand.nextFloat()/3, -0.02, worldIn.rand.nextFloat()/3 - worldIn.rand.nextFloat()/3, 4592659);
        }
