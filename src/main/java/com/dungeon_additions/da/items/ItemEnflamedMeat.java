...
public class ItemEnflamedMeat extends ItemFood implements IHasModel {
    private String info_loc;

    public ItemEnflamedMeat(String name, String info_loc, int amount, float saturation, boolean isWolfFood) {
    ...
    public ItemStack onItemUseFinish(ItemStack itemStack, World world, EntityLivingBase living) {
        if (living instanceof EntityPlayer && !world.isRemote) {
            living.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 1200, 1));
        }
