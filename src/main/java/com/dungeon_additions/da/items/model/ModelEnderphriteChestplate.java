...
public class ModelEnderphriteChestplate extends ModelBiped {
	private final ModelRenderer body;
	private final ModelRenderer LArm;
	private final ModelRenderer RArm;

	public ModelEnderphriteChestplate(float size) {
		super(size, 0, 64,64);
		textureWidth = 64;
		textureHeight = 64;
		...
		LArm.cubeList.add(new ModelBox(LArm, 0, 55, 0.0F, -2.0F, -2.0F, 4, 5, 4, 0.3F, false));
		LArm.cubeList.add(new ModelBox(LArm, 24, 8, 0.0F, -6.6F, -2.0F, 4, 4, 4, 0.3F, false));

		RArm = new ModelRenderer(this);
		RArm.setRotationPoint(0.5F, 0.0F, 0.0F);
		RArm.cubeList.add(new ModelBox(RArm, 0, 46, -4.0F, -2.0F, -2.0F, 4, 5, 4, 0.3F, false));
		RArm.cubeList.add(new ModelBox(RArm, 24, 0, -4.0F, -6.6F, -2.0F, 4, 4, 4, 0.3F, false));
