package com.dungeon_additions.da.items.model;// Made with Blockbench 4.12.3
...
public class ModelKingHelmet extends ModelBiped {
	private final ModelRenderer head;

	public ModelKingHelmet(float size) {
		super(size, 0, 64, 64);
		textureWidth = 64;
		textureHeight = 64;
