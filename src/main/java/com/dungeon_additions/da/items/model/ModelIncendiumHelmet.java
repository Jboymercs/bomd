package com.dungeon_additions.da.items.model;// Made with Blockbench 4.12.4
...
public class ModelIncendiumHelmet extends ModelBiped {
	private final ModelRenderer head;

	public ModelIncendiumHelmet(float size) {
		super(size, 0, 64,64);
		textureWidth = 64;
		textureHeight = 64;
		...
		head.cubeList.add(new ModelBox(head, 32, 6, 6.0F, -12.0F, -1.0F, 2, 5, 2, 0.0F, true));
		head.cubeList.add(new ModelBox(head, 32, 13, 6.0F, -12.0F, -4.0F, 2, 2, 3, 0.0F, true));
		head.cubeList.add(new ModelBox(head, 32, 0, -5.0F, -7.5F, -1.5F, 10, 3, 3, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 16, -4.0F, -13.0F, -4.0F, 8, 5, 8, 0.0F, false));
