package com.dungeon_additions.da.items.model;// Made with Blockbench 4.11.2
...
public class ModelDraugrHelmet extends ModelBiped {
	private final ModelRenderer head;

	public ModelDraugrHelmet(float size) {
		super(size, 0, 64,64);
		textureWidth = 64;
		textureHeight = 64;
		...
		head.cubeList.add(new ModelBox(head, 32, 0, -10.0F, -13.5F, -1.0F, 2, 7, 2, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 32, 9, 5.0F, -13.5F, -1.0F, 3, 2, 2, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 32, 28, -8.0F, -13.5F, -1.0F, 3, 2, 2, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 20, -1.0F, -9.0F, -5.0F, 2, 4, 10, 0.0F, false));
