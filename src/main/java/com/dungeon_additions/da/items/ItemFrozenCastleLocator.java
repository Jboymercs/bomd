...
public class ItemFrozenCastleLocator extends ItemBase{
    private String info_loc;
    public ItemFrozenCastleLocator(String name, String info_loc) {
        super(name);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if(!worldIn.isRemote) {
            ...
            if (particlePos != null) {
                EntityFrozenCastleLocator entityendereye = new EntityFrozenCastleLocator(worldIn, playerIn.posX, playerIn.posY + (double) (playerIn.height / 2.0F), playerIn.posZ);
