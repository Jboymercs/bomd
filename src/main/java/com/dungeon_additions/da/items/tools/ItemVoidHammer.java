    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand)
    {
        ...
        if(!world.isRemote && !player.getCooldownTracker().hasCooldown(this)) {
            if(player.isSneaking()) {
                ...
                EntityVoidBlackHole blackHole = new EntityVoidBlackHole(world, player, this.getAttackDamage() + ModUtils.addMageSetBonus(player, 0, 2) + ModUtils.addAbilityBonusDamage(stack, 0.75F));
