...
public class ItemFieryRespite extends ItemPotion implements IHasModel {
    private String info_loc;

    public ItemFieryRespite(String name, String info_loc) {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving) {
        ...
        if (!worldIn.isRemote) {
            entityLiving.addPotionEffect(new PotionEffect(ModPotions.FIERY_RESPITE, 3800, 0, false, true));
        }
