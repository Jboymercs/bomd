...
public class ItemClairvoyance extends ItemPotion implements IHasModel {
    private String info_loc;

    public ItemClairvoyance(String name, String info_loc) {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving) {
        ...
        if (!worldIn.isRemote) {
            entityLiving.addPotionEffect(new PotionEffect(ModPotions.CLAIRVOYANCE, 8400, 0, false, false));
