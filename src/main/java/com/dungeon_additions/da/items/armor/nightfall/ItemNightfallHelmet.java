...
import com.dungeon_additions.da.items.armor.ItemKingHelmet;
...
public class ItemNightfallHelmet extends ItemArmor implements IHasModel {
    ...
    public ItemNightfallHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String info_loc) {
        ...
        this.knockbackResistance = new AttributeModifier("nightfallHelmetKnockbackResistance", 0.3, 1);
        this.kingSpeedBoost = new AttributeModifier("nightfallHelmetBoost", 2, 0);
    }
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            multimap.put(SharedMonsterAttributes.MAX_HEALTH.getName(), this.kingSpeedBoost);
    ...
    public ItemNightfallHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/nightfall_helmet.png";
    }
}
