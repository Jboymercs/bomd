...
public class ModWyrkArmor extends ItemArmor implements IHasModel {
    ...
    public ModWyrkArmor(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ModWyrkArmor setArmorBonusDesc(String armorBonusDesc) {
