package com.dungeon_additions.da.items.armor.fallen;
...
public class ItemFallenChestplate extends ItemArmor implements IHasModel {
    ...
    public ItemFallenChestplate(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
        ...
        this.knockbackResistance = new AttributeModifier("fallen_chestplate_buff", 0.05, 1);
    }
    ...
    public ItemFallenChestplate setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/fallen_chestplate.png";
    }
}
