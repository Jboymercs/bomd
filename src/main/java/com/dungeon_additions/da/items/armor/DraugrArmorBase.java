...
public class DraugrArmorBase extends ItemArmor implements IHasModel {
    ...
    public DraugrArmorBase(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public DraugrArmorBase setArmorBonusDesc(String armorBonusDesc) {
