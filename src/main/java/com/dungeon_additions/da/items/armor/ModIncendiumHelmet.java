...
public class ModIncendiumHelmet extends ItemArmor implements IHasModel {
...
//    private final AttributeModifier knockbackResistance;
    ...
    public ModIncendiumHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ModIncendiumHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/incendium_helmet.png";
    }
}
