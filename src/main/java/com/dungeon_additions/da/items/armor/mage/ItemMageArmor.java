...
public class ItemMageArmor extends ItemArmor implements IHasModel {
    ...
    public ItemMageArmor(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ItemMageArmor setArmorBonusDesc(String armorBonusDesc) {
