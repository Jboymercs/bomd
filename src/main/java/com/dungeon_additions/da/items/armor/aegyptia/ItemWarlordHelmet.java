package com.dungeon_additions.da.items.armor.aegyptia;
...
public class ItemWarlordHelmet  extends ItemArmor implements IHasModel {
    ...
    public ItemWarlordHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
        ...
        ModItems.ITEMS.add(this);
            this.knockbackResistance = new AttributeModifier("warlordSpeedBoost", 0.03, 1);
    }
    ...
    public ItemWarlordHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/warlord_helmet.png";
    }
}
