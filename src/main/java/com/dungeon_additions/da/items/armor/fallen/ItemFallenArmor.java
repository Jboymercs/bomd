...
public class ItemFallenArmor extends ItemArmor implements IHasModel {
    ...
    public ItemFallenArmor(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
        ...
        this.knockbackResistance = new AttributeModifier("fallen_bonus" + slotIn.getName(), 0.05, 0);
    }
    ...
    public ItemFallenArmor setArmorBonusDesc(String armorBonusDesc) {
