...
public class ItemNovikHelmet extends ItemArmor implements IHasModel {
...
//    private final AttributeModifier knockbackResistance;
    ...
    public ItemNovikHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ItemNovikHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/novik_helmet.png";
    }
}
