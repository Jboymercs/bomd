...
public class ItemColossusChestplate  extends ItemArmor implements IHasModel {
    ...
    public ItemColossusChestplate(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
        ...
        ModItems.ITEMS.add(this);
            this.knockbackResistance = new AttributeModifier("colossus_speed", -0.03, 1);
        this.healthBoostModif = new AttributeModifier("colossusHealthBoost", 1, 0);
    }
    ...
    public ItemColossusChestplate setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/colossus_chestplate.png";
    }
}
