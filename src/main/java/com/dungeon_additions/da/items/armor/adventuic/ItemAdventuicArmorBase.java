...
public class ItemAdventuicArmorBase extends ItemArmor implements IHasModel {
    ...
    public ItemAdventuicArmorBase(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
        ...
        this.knockbackResistance = new AttributeModifier("adventureAttackSpeed_" + slotIn.getName(), -0.04, 1);
    }
    ...
    public ItemAdventuicArmorBase setArmorBonusDesc(String armorBonusDesc) {
