...
public class ItemEnderphriteHelmet extends ItemArmor implements IHasModel {
    ...
    public ItemEnderphriteHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ItemEnderphriteHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/enderphrite_helmet.png";
    }
}
