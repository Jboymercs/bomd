package com.dungeon_additions.da.items.armor.mage;
...
public class ItemMageHelmet extends ItemArmor implements IHasModel {
    ...
    public ItemMageHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ItemMageHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/mage_helmet.png";
    }
}
