...
import com.dungeon_additions.da.items.armor.ModWyrkArmor;
...
public class ItemImperialArmor extends ItemArmor implements IHasModel {
    ...
    public ItemImperialArmor(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            multimap.put(SharedMonsterAttributes.MOVEMENT_SPEED.getName(), new AttributeModifier(MOVEMENT_SPEED_MODIFIER, "Movement Speed", -0.02, 0));
        }
    ...
    public ItemImperialArmor setArmorBonusDesc(String armorBonusDesc) {
