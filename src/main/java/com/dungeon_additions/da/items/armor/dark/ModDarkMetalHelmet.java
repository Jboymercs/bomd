package com.dungeon_additions.da.items.armor.dark;
...
public class ModDarkMetalHelmet extends ItemArmor implements IHasModel {
    ...
    public ModDarkMetalHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ModDarkMetalHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/dark_metal_helmet.png";
    }
}
