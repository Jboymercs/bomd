...
public class ModDarkArmorBase extends ItemArmor implements IHasModel {
    ...
    public ModDarkArmorBase(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ModDarkArmorBase setArmorBonusDesc(String armorBonusDesc) {
