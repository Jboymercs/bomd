...
public class ItemNovikArmor  extends ItemArmor implements IHasModel {
    ...
    public ItemNovikArmor (String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ItemNovikArmor setArmorBonusDesc(String armorBonusDesc) {
