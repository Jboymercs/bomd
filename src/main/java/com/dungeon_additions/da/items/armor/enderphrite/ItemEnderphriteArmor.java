...
public class ItemEnderphriteArmor extends ItemArmor implements IHasModel {
    ...
    public ItemEnderphriteArmor(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ItemEnderphriteArmor setArmorBonusDesc(String armorBonusDesc) {
