...
public class ModWyrkHelmet extends ItemArmor implements IHasModel {
    ...
    public ModWyrkHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ModWyrkHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/wyrk_helmet.png";
    }
}
