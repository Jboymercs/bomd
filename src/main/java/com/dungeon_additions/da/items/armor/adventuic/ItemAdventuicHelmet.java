package com.dungeon_additions.da.items.armor.adventuic;
...
public class ItemAdventuicHelmet  extends ItemArmor implements IHasModel {
    ...
    public ItemAdventuicHelmet(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
        ...
        this.knockbackResistance = new AttributeModifier("adventuic_helmet_buff", -0.04, 1);
    }
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            multimap.put(SharedMonsterAttributes.ARMOR_TOUGHNESS.getName(), new AttributeModifier(ARMOR_MODIFIERS[equipmentSlot.getIndex()], "Armor toughness", 2F * ModConfig.armor_toughness_scaling, 0));
    ...
    public ItemAdventuicHelmet setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/adventure_helmet.png";
    }
}
