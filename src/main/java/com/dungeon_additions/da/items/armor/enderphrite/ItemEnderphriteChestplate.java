package com.dungeon_additions.da.items.armor.enderphrite;
...
public class ItemEnderphriteChestplate  extends ItemArmor implements IHasModel {
    ...
    public ItemEnderphriteChestplate(String name, ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ItemEnderphriteChestplate setArmorBonusDesc(String armorBonusDesc) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ModReference.MOD_ID + ":textures/models/armor/enderphrite_chestplate.png";
    }
}
