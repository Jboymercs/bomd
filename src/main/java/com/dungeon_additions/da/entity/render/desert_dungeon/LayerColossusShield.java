...
public class LayerColossusShield extends RenderAbstractLayer<EntityAegyptianColossus> {
    ...
    private static final ResourceLocation TEXTURE_INNER_ORB = new ResourceLocation(ModReference.MOD_ID, "textures/entity/aegyptia/aegyptian_colossus_shield.png");

    public LayerColossusShield(GeoEntityRenderer<EntityAegyptianColossus> renderer, Function<EntityAegyptianColossus, ResourceLocation> funcGetCurrentTexture, Function<EntityAegyptianColossus, ResourceLocation> funcGetCurrentModel) {
