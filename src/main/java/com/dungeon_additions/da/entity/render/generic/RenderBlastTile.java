...
import com.dungeon_additions.da.entity.render.util.BlockRenderer;
...
public class RenderBlastTile extends Render<EntityBlastTile> {

    private static final BlockRenderer blockRenderer = new BlockRenderer();

    public RenderBlastTile(RenderManager renderManager) {
        super(renderManager);
    }

    @Override
    public void doRender(EntityBlastTile entity, double x, double y, double z, float yaw, float tick) {
        if(entity.posY != entity.origin.getY())
            renderShockwaveBlock(entity, x, y, z, yaw, tick);
    }


    public void renderShockwaveBlock(EntityBlastTile entity, double x, double y, double z, float yaw, float tick) {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityBlastTile entity) {
        return null;
    }
}
