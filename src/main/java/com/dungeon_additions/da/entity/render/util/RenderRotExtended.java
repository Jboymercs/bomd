...
public abstract class RenderRotExtended <T extends EntityAbstractBase & IAnimatable> extends GeoEntityRenderer<T> {
    ...
    protected RenderRotExtended(RenderManager renderManager, AnimatedGeoModel<T> modelProvider) {
        this(renderManager, modelProvider, 1D, 1D, 0);
    }

    protected RenderRotExtended(RenderManager renderManager, AnimatedGeoModel<T> modelProvider, double widthScale, double heightScale, float shadowSize) {
        ...
        if (this.currentModelRenderCycle == 0) {
            ...
            if (boneItem != null || boneBlock != null) {
                ...
                if (boneBlock != null) {
                    ...
                    GlStateManager.translate(0.f, 0.25f, 0f);
                    //float angle = (System.currentTimeMillis() / 40) % 360;
