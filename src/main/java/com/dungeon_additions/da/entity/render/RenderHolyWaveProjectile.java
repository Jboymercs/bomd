...
public class RenderHolyWaveProjectile <T extends Entity> extends Render<T> {
    private final RenderItem itemRenderer;
    private final Item itemToRender;

    public RenderHolyWaveProjectile(RenderManager renderManagerIn, RenderItem itemRendererIn, Item item) {
