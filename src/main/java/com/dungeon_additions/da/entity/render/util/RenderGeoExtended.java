...
public abstract class RenderGeoExtended <T extends EntityAbstractBase & IAnimatable> extends GeoEntityRenderer<T> {
    ...
    protected RenderGeoExtended(RenderManager renderManager, AnimatedGeoModel<T> modelProvider, double widthScale, double heightScale, float shadowSize) {
