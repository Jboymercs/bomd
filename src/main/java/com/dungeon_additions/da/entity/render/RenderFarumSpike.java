...
public class RenderFarumSpike extends Render<EntityFarumSpike> {

    public RenderFarumSpike(RenderManager renderManager)
    {
        super(renderManager);
    ...
    public void renderDart(EntityFarumSpike dart, double d, double d1, double d2, float f, float f1)
    {
        if (dart.isInvisible())
        {
            return;
    ...
    @Override
    public void doRender(EntityFarumSpike entity, double d, double d1, double d2, float f, float f1)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityFarumSpike entity)
    {

        return new ResourceLocation(ModReference.MOD_ID, "textures/entity/dart_farum.png");
    }
}
