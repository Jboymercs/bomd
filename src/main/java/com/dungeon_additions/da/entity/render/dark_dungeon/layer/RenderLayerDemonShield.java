...
public class RenderLayerDemonShield extends RenderAbstractLayer<EntityDarkdriftDevil> {
    ...
    private static final ResourceLocation TEXTURE_INNER_ORB = new ResourceLocation(ModReference.MOD_ID, "textures/entity/demon_shield.png");

    public RenderLayerDemonShield(GeoEntityRenderer<EntityDarkdriftDevil> renderer, Function<EntityDarkdriftDevil, ResourceLocation> funcGetCurrentTexture, Function<EntityDarkdriftDevil, ResourceLocation> funcGetCurrentModel) {
    ...
    public void render(EntityDarkdriftDevil entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, Color renderColor) {
        if(entitylivingbaseIn.isMeditationLoop()) {
            ...
            GlStateManager.translate(f * 0.001F, f * 0.003F, 0.0F);
