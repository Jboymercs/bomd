...
public abstract class RenderAbstractLayer<T extends EntityLivingBase & IAnimatable> extends GeoLayerRenderer<T> {
    ...
    public RenderAbstractLayer(GeoEntityRenderer<T> renderer, Function<T, ResourceLocation> funcGetCurrentTexture, Function<T, ResourceLocation> funcGetCurrentModel) {
        super(renderer);
