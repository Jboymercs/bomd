...
public class RenderDartBase extends Render<EntityBlossomDart> {

    public RenderDartBase(RenderManager renderManager)
    {
        super(renderManager);
    ...
    public void renderDart(EntityBlossomDart dart, double d, double d1, double d2, float f, float f1)
    {
        if (dart.isInvisible())
        {
            return;
    ...
    @Override
    public void doRender(EntityBlossomDart entity, double d, double d1, double d2, float f, float f1)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityBlossomDart entity)
    {

        return new ResourceLocation(ModReference.MOD_ID, "textures/entity/dart.png");
    }
}
