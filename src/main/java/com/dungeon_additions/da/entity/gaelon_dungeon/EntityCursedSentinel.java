...
public class EntityCursedSentinel extends EntityGaelonBase implements IAnimatable, IAnimationTickable, IAttack, IScreenShake {
    ...
    private static final DataParameter<Boolean> SWING = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SWING_TWO = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> OVERHEAD_SWING = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SHOOT_CANNON = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> MORTAR_FIRE = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> AWAKE_STATE = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> INANIMATE_STATE = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SHAKING = EntityDataManager.createKey(EntityCursedSentinel.class, DataSerializers.BOOLEAN);
    ...
    public void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(MobConfig.cursed_sentinel_health);
    ...
    public void initEntityAI() {
        super.initEntityAI();
        this.tasks.addTask(4, new EntityAICursedGolemAttack<>(this, 1.0D, 10, 6, 0.3F));
