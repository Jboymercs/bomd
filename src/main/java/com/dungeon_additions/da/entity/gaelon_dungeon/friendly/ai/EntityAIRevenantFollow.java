...
public class EntityAIRevenantFollow extends EntityAIBase {
    private final EntityFriendlyCursedRevenant tameable;
    ...
    public EntityAIRevenantFollow(EntityFriendlyCursedRevenant tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
