    ...
    public void doAction() {
        ...
        actor.addEvent(()-> {
            ...
            actor.addEvent(()-> {
                ...
                ModUtils.handleAreaImpact(1.5F, (e) -> this.actor.getAttack(), this.actor, this.actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, 0))), source, 0, 0, false, 0.8F);
