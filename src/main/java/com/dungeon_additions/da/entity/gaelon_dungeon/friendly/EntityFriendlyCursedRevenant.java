package com.dungeon_additions.da.entity.gaelon_dungeon.friendly;
...
import com.dungeon_additions.da.entity.gaelon_dungeon.friendly.ai.EntityAIFriendlyRevenantAttack;
...
import com.dungeon_additions.da.entity.sky_dungeon.friendly.ai.EntityAIHalberdFollow;
import com.dungeon_additions.da.entity.sky_dungeon.friendly.ai.EntityAIHalberdHurtByTarget;
import com.dungeon_additions.da.entity.sky_dungeon.friendly.ai.EntityHalberdOwnerAttack;
...
public class EntityFriendlyCursedRevenant extends EntityGaelonBase implements IAnimatable, IAnimationTickable, IAttack {
    ...
    private static final DataParameter<Boolean> SWING = EntityDataManager.createKey(EntityFriendlyCursedRevenant.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SWING_TWO = EntityDataManager.createKey(EntityFriendlyCursedRevenant.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> ORB_MODE = EntityDataManager.createKey(EntityFriendlyCursedRevenant.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> USE_SHIELD = EntityDataManager.createKey(EntityFriendlyCursedRevenant.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> CAST = EntityDataManager.createKey(EntityFriendlyCursedRevenant.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> TELEPORT_PIERCE = EntityDataManager.createKey(EntityFriendlyCursedRevenant.class, DataSerializers.BOOLEAN);
    protected static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.<Optional<UUID>>createKey(EntityFriendlyCursedRevenant.class, DataSerializers.OPTIONAL_UNIQUE_ID);
    ...
    public EntityFriendlyCursedRevenant(World worldIn, float x, float y, float z) {
        super(worldIn, x, y, z);
    ...
    public void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(MobConfig.reanimate_damage * 0.8);
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.28D);
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(MobConfig.reanimate_health * 0.8);
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(MobConfig.reanimate_armor * 0.8);
    ...
    public void initEntityAI() {
        super.initEntityAI();
        this.tasks.addTask(4, new EntityAIFriendlyRevenantAttack<>(this, 1.0D, 10, 7, 0.3F));
        this.tasks.addTask(5, new EntityAIRevenantFollow(this, 1.4D, 6, 20));
        ...
        this.targetTasks.addTask(3, new EntityAIRevenantHurtByTarget(this));
        this.targetTasks.addTask(4, new EntityAIRevenantOwnerAttack(this));
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if(this.isOrbMode() || this.isUseShield() || this.usingShieldOff || source.getImmediateSource() == this || this.getOwner() != null && source.getImmediateSource() == this.getOwner()) {
    ...
    private void sendMessageToOwner() {
        Objects.requireNonNull(this.getOwner()).sendMessage(new TextComponentString(TextFormatting.WHITE + "Your Summoned Revenant has returned to there world..."));
    }
