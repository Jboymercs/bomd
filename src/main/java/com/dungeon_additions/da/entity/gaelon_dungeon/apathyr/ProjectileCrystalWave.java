...
public class ProjectileCrystalWave extends Projectile {
        ...
        if (block.isFullCube()) {
            for (int i = 0; i < this.PARTICLE_AMOUNT; i++) {
                ...
                for (float y = 0; y < height; y += 0.5f) {
                    ...
                    ParticleManager.spawnDust(world, pos, ModColors.AZURE, Vec3d.ZERO, ModRand.range(5, 10));
                }
    ...
    protected void onQuakeUpdate() {
        List<Entity> list = world.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().grow(0.5));
