...
public class EntityAIVoidiant  <T extends EntityVoidiant & IAttack> extends EntityAIBase {
    ...
    public EntityAIVoidiant(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAIVoidiant(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
    ...
    public void updateTask() {
        ...
        if (target == null || this.entity.isIdleState()) {
            return;
        }
