...
public class EntityReAnimateAttackAI <T extends EntityReAnimate & IAttack> extends EntityAIBase {
    ...
    public EntityReAnimateAttackAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityReAnimateAttackAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
