...
public class EntityAIAttackRotKnight<T extends EntityRotKnight & IAttack> extends EntityAIBase {
    ...
    public EntityAIAttackRotKnight(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAIAttackRotKnight(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
