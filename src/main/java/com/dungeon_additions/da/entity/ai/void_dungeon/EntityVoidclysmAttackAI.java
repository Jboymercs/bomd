...
public class EntityVoidclysmAttackAI extends EntityAIBase {
    private final EntityVoidiclysm entity;
    ...
    private final VoidclysmPassiveCircle<EntityVoidiclysm> circleAI;

    private static final int MEMORY = 100;

    public EntityVoidclysmAttackAI(EntityVoidiclysm entity, float maxAttackDistance, float idealAttackDistance, float lookSpeed, IAttackInitiator attackInitiator) {
        this.entity = entity;
        this.maxAttackDistSq = maxAttackDistance * maxAttackDistance;
        this.lookSpeed = lookSpeed;
        this.attackInitiator = attackInitiator;
        circleAI = new VoidclysmPassiveCircle<>(entity);
        this.setMutexBits(3);
    }
