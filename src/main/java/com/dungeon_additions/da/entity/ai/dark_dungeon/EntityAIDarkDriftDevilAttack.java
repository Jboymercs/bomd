...
public class EntityAIDarkDriftDevilAttack  <T extends EntityDarkdriftDevil & IAttack> extends EntityAIBase {
    ...
    public EntityAIDarkDriftDevilAttack (T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAIDarkDriftDevilAttack (T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
