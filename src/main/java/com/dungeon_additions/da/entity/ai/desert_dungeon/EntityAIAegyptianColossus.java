...
public class EntityAIAegyptianColossus <T extends EntityAegyptianColossus & IAttack> extends EntityAIBase {
    ...
    public EntityAIAegyptianColossus(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 40.0f);
    }

    public EntityAIAegyptianColossus(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
