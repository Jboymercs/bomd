...
public class EntityTimedAttackIncendium <T extends EntityIncendium & IAttack> extends EntityAIBase {
    ...
    public EntityTimedAttackIncendium(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityTimedAttackIncendium(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
    ...
    public void updateTask() {
        ...
        if (canSee) {
            ...
            } else if (distSq <= this.maxAttackDistSq){
                this.attackTime--;
                if (this.attackTime <= 0) {
                    this.attackTime = this.entity.startAttack(target, (float) distSq, this.strafingBackwards);
                }
