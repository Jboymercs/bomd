...
public class EntityFriendlyCursedGolemAttack   <T extends EntityFriendlyCursedGolem & IAttack> extends EntityAIBase {
    ...
    public EntityFriendlyCursedGolemAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityFriendlyCursedGolemAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
