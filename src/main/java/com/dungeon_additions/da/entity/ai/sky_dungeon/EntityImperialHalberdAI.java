...
public class EntityImperialHalberdAI <T extends EntityImperialHalberd & IAttack> extends EntityAIBase {
    ...
    public EntityImperialHalberdAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityImperialHalberdAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
