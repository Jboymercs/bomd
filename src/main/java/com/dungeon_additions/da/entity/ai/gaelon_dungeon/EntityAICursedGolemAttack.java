...
public class EntityAICursedGolemAttack  <T extends EntityCursedSentinel & IAttack> extends EntityAIBase {
    ...
    public EntityAICursedGolemAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAICursedGolemAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
