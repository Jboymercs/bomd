package com.dungeon_additions.da.entity.ai.flying.gargoyle;
...
public class AIPassiveCircleG <T extends EntityTridentGargoyle> extends EntityAIBase {
    private final T entity;
    private @Nullable Vec3d planeVectorPath = getNewPlaneVector();
    private final float circleRadius;

    public AIPassiveCircleG(T entity, float circleRadius) {
        this.entity = entity;
    ...
    public void updateTask() {
        if(entity.getAttackTarget() != null && !this.entity.lockLook && !this.entity.standbyOnVel && !this.entity.overrideInstincts) {
    ...
    private Vec3d getNewPlaneVector() {
        return ModUtils.Y_AXIS.add(ModRand.randVec().scale(0.5)).normalize();
    }
