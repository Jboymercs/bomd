...
public class EntityAIAttackRotKnightRapier<T extends EntityRotKnightRapier & IAttack> extends EntityAIBase {
    ...
    public EntityAIAttackRotKnightRapier(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAIAttackRotKnightRapier(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
