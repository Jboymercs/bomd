...
public class EntityVolatileSpiritAI <T extends EntityVolatileSpirit & IAttack> extends EntityAIBase {
    ...
    public EntityVolatileSpiritAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityVolatileSpiritAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
