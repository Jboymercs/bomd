...
import com.dungeon_additions.da.entity.ai.void_dungeon.VoidclysmPassiveCircle;
...
public class EntityDauntlessAttackAI extends EntityAIBase {
    private final EntityDauntless entity;
    ...
    private final DauntlessPassiveCircle<EntityDauntless> circleAI;

    public EntityDauntlessAttackAI(EntityDauntless entity, float maxAttackDistance, float idealAttackDistance, float lookSpeed, IAttackInitiator attackInitiator) {
        this.entity = entity;
        this.maxAttackDistSq = maxAttackDistance * maxAttackDistance;
        this.lookSpeed = lookSpeed;
        this.attackInitiator = attackInitiator;
        circleAI = new DauntlessPassiveCircle<>(entity);
        this.setMutexBits(3);
    }
    ...
    public void move(EntityLivingBase target, double distSq, boolean canSee) {
        if(!this.entity.lockLook) {
            ...
            if (this.entity instanceof IPitch && !entity.isRangedMode()) {
