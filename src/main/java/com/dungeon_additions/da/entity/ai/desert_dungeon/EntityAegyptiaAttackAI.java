...
public class EntityAegyptiaAttackAI <T extends EntityAegyptia & IAttack> extends EntityAIBase {
    ...
    public EntityAegyptiaAttackAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAegyptiaAttackAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
    ...
    public void move(EntityLivingBase target, double distSq, boolean canSee) {
        if(!entity.lockLook) {
            if(canSee && !this.entity.byPassStrafing) {
                if(this.entity.isHasKopis() && distSq < 19) {
