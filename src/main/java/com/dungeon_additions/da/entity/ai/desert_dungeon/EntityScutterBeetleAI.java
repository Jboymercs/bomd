...
public class EntityScutterBeetleAI <T extends EntityScutterBeetle & IAttack> extends EntityAIBase {
    ...
    public EntityScutterBeetleAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityScutterBeetleAI(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
