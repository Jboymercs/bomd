...
public class EntityAIFlameKnightAttack <T extends EntityFlameKnight & IAttack> extends EntityAIBase {
    ...
    public EntityAIFlameKnightAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAIFlameKnightAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
