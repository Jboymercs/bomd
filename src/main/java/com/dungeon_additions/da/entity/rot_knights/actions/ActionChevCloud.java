...
public class ActionChevCloud implements IAction {
    @Override
    public void performAction(EntityAbstractBase actor, EntityLivingBase target) {
        ...
        actor.addEvent(()-> {
            ProjectileDelayedPoisonCloud cloud = new ProjectileDelayedPoisonCloud(actor.world, actor, (float) actor.getAttack() * 0.75F, 35);
            ...
            actor.playSound(SoundsHandler.COLOSSUS_HILT_SLAM, 1.0f, 1.5f / (rand.nextFloat() * 0.4F + 0.4f));
        }, 1);
