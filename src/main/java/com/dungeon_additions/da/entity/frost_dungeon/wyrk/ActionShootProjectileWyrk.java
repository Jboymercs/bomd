...
public class ActionShootProjectileWyrk implements IAction {
    ...
    public void performAction(EntityAbstractBase actor, EntityLivingBase target) {
        ...
        Vec3d relPos = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(0,2.5,0)));
        ...
        for(int i = 0; i < 50; i++) {
            actor.addEvent(()-> {
                Vec3d pos = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(0,2.5,0)));
        ...
        actor.addEvent(()-> {
            ...
            Vec3d targetPos = target.getPositionEyes(1.0F).add(ModUtils.getRelativeOffset(actor, new Vec3d(0,-0.25 , 0)));
            ...
            ModUtils.lineCallback(lineStart, lineEnd, 1, (pos, i) -> {
                ModUtils.throwProjectileNoSpawn(pos,missile,1F, speed);
            });
        }, 51);
