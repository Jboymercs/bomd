...
public class ActionGroundSweep implements IAction {

    Supplier<Projectile> projectileSupplier;
    float velocity;

    public ActionGroundSweep(Supplier<Projectile> projectileSupplier, float velocity) {
    ...
    public void performAction(EntityAbstractBase actor, EntityLivingBase target) {
        ...
        actor.playSound(SoundsHandler.LICH_SHOOT_MISSILE, 1.5f, 0.4F / (new Random().nextFloat() * 0.4F + 0.4f));
        ...
        Vec3d relPos = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, -1)));
        Vec3d relPos2 = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, 1)));
        Vec3d relPos3 = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, 0)));
        Vec3d relPos4 = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, -2)));
        Vec3d relPos5 = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, 2)));
        Vec3d relPos6 = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, -3)));
        Vec3d relPos7 = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(2.5, 0, 3)));
