...
public class ActionWyrkLazer implements IMultiAction{
    ...
    public ActionWyrkLazer(EntityAbstractBase actorIn, byte stopLaserByte, Consumer<Vec3d> onLaserImpact) {
        this.entity = actorIn;
