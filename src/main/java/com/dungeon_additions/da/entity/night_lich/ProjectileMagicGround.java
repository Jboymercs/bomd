...
public class ProjectileMagicGround extends Projectile {
    protected static final float AREA_FACTOR = 0.5f;

    public static final int PARTICLE_AMOUNT = 1;
    protected int updates = 5;

    public ProjectileMagicGround(World worldIn, EntityLivingBase throwerIn, float baseDamage, ItemStack stack) {
    ...
    public ProjectileMagicGround(World worldIn, EntityLivingBase throwerIn, float baseDamage, ItemStack stack, EntityPlayer owner) {
        super(worldIn, throwerIn, baseDamage);
        this.setNoGravity(true);
        this.setSize(0.25F, 1);
        this.player = owner;
    ...
    public ProjectileMagicGround(World worldIn) {
        super(worldIn);
    }

    public ProjectileMagicGround(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
