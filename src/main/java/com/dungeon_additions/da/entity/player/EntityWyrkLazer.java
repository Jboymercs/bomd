...
public class EntityWyrkLazer extends Entity implements IDirectionalRender {

    private Vec3d renderLazerPos;
    public static final int TICK_LIFE = 30;

    public EntityWyrkLazer(World worldIn) {
        super(worldIn);
    }

    public EntityWyrkLazer(World worldIn, Vec3d renderLazerPos) {
        super(worldIn);
