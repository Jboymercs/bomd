...
public class ActionPlayerBloodPile implements IActionProjectile {
    @Override
    public void performAction(Projectile actor, EntityLivingBase target) {
        ModUtils.circleCallback(0, 1, (pos)-> {
            ...
            int y = getSurfaceHeight(actor.world, new BlockPos(pos.x, 0, pos.z), (int) actor.posY - 5, (int) actor.posY + 3);
