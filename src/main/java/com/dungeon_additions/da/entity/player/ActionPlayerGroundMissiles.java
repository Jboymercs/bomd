...
public class ActionPlayerGroundMissiles implements IActionPlayer{
    ...
    public void performAction(EntityPlayer actor) {
        ...
        ProjectileMagicGround missile = new ProjectileMagicGround(actor.world, actor, (float) (MobConfig.night_lich_attack_damage * additionalDamage) + ModUtils.addMageSetBonus(actor, 0, 1.25F), null, actor);
        ProjectileMagicGround missile_2 = new ProjectileMagicGround(actor.world, actor, (float) (MobConfig.night_lich_attack_damage * additionalDamage) + ModUtils.addMageSetBonus(actor, 0, 1.25F), null, actor);
        ProjectileMagicGround missile_3 = new ProjectileMagicGround(actor.world, actor, (float) (MobConfig.night_lich_attack_damage * additionalDamage) + ModUtils.addMageSetBonus(actor, 0, 1.25F), null, actor);
