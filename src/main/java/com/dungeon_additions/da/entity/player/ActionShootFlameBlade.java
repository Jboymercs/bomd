...
public class ActionShootFlameBlade implements IActionPlayer{
    ...
    public void performAction(EntityPlayer actor) {
        ...
        ProjectileFlameBlade blade = new ProjectileFlameBlade(actor.world, actor, damage + ModUtils.addMageSetBonus(actor, 0, 1.5F) + ModUtils.addAbilityBonusDamage(actor.getHeldItemMainhand(), 1.25F));
