...
public class ActionPlayerShootBloodSpray implements IActionPlayer{
    ...
    public void performAction(EntityPlayer actor) {
        ...
        ProjectileKingBlood blood = new ProjectileKingBlood(actor.world, actor, damage, false);
        ...
        ProjectileKingBlood blood2 = new ProjectileKingBlood(actor.world, actor, damage, false);
        ...
        ProjectileKingBlood blood3 = new ProjectileKingBlood(actor.world, actor, damage, false);
