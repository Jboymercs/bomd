...
public class ActionFireRuneAttack implements IActionPlayer {
    @Override
    public void performAction(EntityPlayer actor) {
        ...
        ModUtils.circleCallback(1, 4, (pos)-> {
            ...
            EntityBlueWave spike = new EntityBlueWave(actor.world, true, false, false, actor, ModConfig.voidic_helmet_damage);
        ...
        ModUtils.circleCallback(5, 12, (pos)-> {
            pos = new Vec3d(pos.x, 0, pos.y).add(targetPos);
            int y = getSurfaceHeight(actor.world, new BlockPos(pos.x, 0, pos.z), (int) actor.posY - 3, (int) actor.posY + 2);
            EntityBlueWave spike = new EntityBlueWave(actor.world, true, false, false, actor, ModConfig.voidic_helmet_damage);
            spike.setPosition(pos.x, y + 1, pos.z);
