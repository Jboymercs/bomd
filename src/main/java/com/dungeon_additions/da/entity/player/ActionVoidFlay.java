...
public class ActionVoidFlay implements IActionPlayer{
    ...
    public void performAction(EntityPlayer actor) {
        ...
        ProjectileVoidClysmBolt blood = new ProjectileVoidClysmBolt(actor.world, actor, damage);
        ...
        ProjectileVoidClysmBolt blood2 = new ProjectileVoidClysmBolt(actor.world, actor, damage);
        ...
        ProjectileVoidClysmBolt blood3 = new ProjectileVoidClysmBolt(actor.world, actor, damage);
