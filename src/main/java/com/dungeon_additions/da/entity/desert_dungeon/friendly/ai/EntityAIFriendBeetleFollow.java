...
public class EntityAIFriendBeetleFollow extends EntityAIBase {
    private final EntityFriendlyScutterBeetle tameable;
    ...
    public EntityAIFriendBeetleFollow(EntityFriendlyScutterBeetle tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
