...
public class ActionHolyWave implements IActionKing{

    private int distance;

    public ActionHolyWave(int distanceFrom) {
    ...
    public void performAction(EntityHighKing actor, EntityLivingBase target) {
        ...
        EntityKingHolyWave wave6 = new EntityKingHolyWave(actor.world, actor, actor.getAttack());
        EntityKingHolyWave wave7 = new EntityKingHolyWave(actor.world, actor, actor.getAttack());
        ...
        wave6.setPosition(relPos5.x, relPos5.y, relPos5.z);
        wave7.setPosition(relPos5.x, relPos5.y, relPos5.z);
        wave.shoot(actor, pitch, actor.rotationYaw - 20, 0.0F, speed, inaccuracy);
        wave2.shoot(actor, pitch, actor.rotationYaw - 10, 0.0F, speed, inaccuracy);
        wave3.shoot(actor, pitch, actor.rotationYaw, 0.0F, speed, inaccuracy);
        wave4.shoot(actor, pitch, actor.rotationYaw + 10, 0.0F, speed, inaccuracy);
        wave5.shoot(actor, pitch, actor.rotationYaw + 20, 0.0F, speed, inaccuracy);
        wave6.shoot(actor, pitch, actor.rotationYaw - 30, 0.0F, speed, inaccuracy);
        wave7.shoot(actor, pitch, actor.rotationYaw + 30, 0.0F, speed, inaccuracy);
        wave.rotationYaw = actor.rotationYaw -20;
        wave2.rotationYaw = actor.rotationYaw -10;
        wave3.rotationYaw = actor.rotationYaw;
        wave4.rotationYaw = actor.rotationYaw + 10;
        wave5.rotationYaw = actor.rotationYaw + 20;
        wave6.rotationYaw = actor.rotationYaw - 30;
        wave7.rotationYaw = actor.rotationYaw + 30;
        wave.setTravelRange(40f);
        wave2.setTravelRange(40F);
        wave3.setTravelRange(40F);
        wave4.setTravelRange(40F);
        wave5.setTravelRange(40F);
        wave6.setTravelRange(40F);
        wave7.setTravelRange(40F);
        ...
        actor.world.spawnEntity(wave6);
        actor.world.spawnEntity(wave7);
    }
}
