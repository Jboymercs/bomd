...
public class EntityAIHalberdFollow extends EntityAIBase {
    private final EntityFriendlyHalberd tameable;
    ...
    public EntityAIHalberdFollow(EntityFriendlyHalberd tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
