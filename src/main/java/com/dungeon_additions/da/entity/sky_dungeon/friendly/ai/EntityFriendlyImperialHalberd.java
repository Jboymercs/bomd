...
public class EntityFriendlyImperialHalberd <T extends EntityFriendlyHalberd & IAttack> extends EntityAIBase {
    ...
    public EntityFriendlyImperialHalberd(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityFriendlyImperialHalberd(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
