package com.dungeon_additions.da.entity.sky_dungeon.high_king.king.ai;
...
public class EntityHighKingTimedAttack <T extends EntityHighKing & IAttack> extends EntityAIBase {
    ...
    public EntityHighKingTimedAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityHighKingTimedAttack(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
