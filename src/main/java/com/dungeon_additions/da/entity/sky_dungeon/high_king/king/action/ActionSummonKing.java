...
public class ActionSummonKing implements IActionKing{
    @Override
    public void performAction(EntityHighKing actor, EntityLivingBase target) {
        ...
        actor.playSound(SoundsHandler.SKY_LIGHTNING_CAST, 0.7f, 0.8f / (new Random().nextFloat() * 0.4f + 0.6f));
        ...
        actor.addEvent(()-> {
            ModUtils.circleCallback(3, 12, (pos)-> {
                ...
                EntitySkyBolt spike = new EntitySkyBolt(actor.world, new Vec3d(pos.x, y + 10, pos.z), true);
                spike.setPosition(pos.x, y + 1, pos.z);
                if(actor.world.rand.nextInt(5) == 0) {
                    actor.world.spawnEntity(spike);
                }
            });
            actor.playSound(SoundsHandler.SKY_LIGHTNING_CAST, 1.0f, 0.8f / (new Random().nextFloat() * 0.4f + 0.6f));
        }, 8);
        ...
        actor.addEvent(()-> {
            ModUtils.circleCallback(4, 16, (pos)-> {
                ...
                EntitySkyBolt spike = new EntitySkyBolt(actor.world, new Vec3d(pos.x, y + 10, pos.z), true);
                spike.setPosition(pos.x, y + 1, pos.z);
                if(actor.world.rand.nextInt(12) == 0) {
                    actor.world.spawnEntity(spike);
                }
            });
            actor.playSound(SoundsHandler.SKY_LIGHTNING_CAST, 1.1f, 0.8f / (new Random().nextFloat() * 0.4f + 0.6f));
        }, 16);
        ...
        actor.addEvent(()-> {
            ...
            actor.playSound(SoundsHandler.SKY_LIGHTNING_CAST, 1.2f, 0.8f / (new Random().nextFloat() * 0.4f + 0.6f));
        }, 24);
        ...
        actor.addEvent(()-> {
            ...
            actor.playSound(SoundsHandler.SKY_LIGHTNING_CAST, 1.3f, 0.8f / (new Random().nextFloat() * 0.4f + 0.6f));
        }, 32);
        ...
        actor.addEvent(()-> {
            ...
            actor.playSound(SoundsHandler.SKY_LIGHTNING_CAST, 1.8f, 0.8f / (new Random().nextFloat() * 0.4f + 0.6f));
        }, 70);
