...
public class EntityFireResistantItems extends EntityItem {
    ...
    public EntityFireResistantItems(World worldIn) {
        super(worldIn);
        this.health = 5;
    ...
    public EntityFireResistantItems(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.health = 5;
    ...
    public EntityFireResistantItems(World worldIn, double x, double y, double z, ItemStack stack) {
        super(worldIn, x, y, z, stack);

        this.isImmuneToFire = true;
    }

    public EntityFireResistantItems(World worldIn, EntityItem itemIn, ItemStack stack) {
    ...
    private void searchForOtherItemsNearby() {
        for (EntityFireResistantItems entityitem : this.world.getEntitiesWithinAABB(EntityFireResistantItems.class, this.getEntityBoundingBox().grow(0.5D, 0.0D, 0.5D))) {
            this.combineItems(entityitem);
        }
    }

    private boolean combineItems(EntityFireResistantItems other) {
        if (other == this) {
            return false;
