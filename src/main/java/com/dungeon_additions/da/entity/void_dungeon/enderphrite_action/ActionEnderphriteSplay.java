package com.dungeon_additions.da.entity.void_dungeon.enderphrite_action;
...
public class ActionEnderphriteSplay implements IAction {
    @Override
    public void performAction(EntityAbstractBase actor, EntityLivingBase target) {
        Vec3d relPos = actor.getPositionVector().add(ModUtils.getRelativeOffset(actor, new Vec3d(1.5, 2, 0)));
        ...
        Vec3d lineDir = ModUtils.rotateVector2(fromTargetTooActor.crossProduct(ModUtils.Y_AXIS), fromTargetTooActor, ModRand.range(-20, 20)).normalize().scale(2.5);
