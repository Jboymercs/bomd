...
public class EntityDarkRuinsLocator extends Projectile{
    public EntityDarkRuinsLocator(World worldIn, EntityLivingBase throwerIn, float damage) {
        super(worldIn, throwerIn, damage);
    }

    public EntityDarkRuinsLocator(World worldIn) {
        super(worldIn);
    ...
    public EntityDarkRuinsLocator(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
