...
public class EntityBurningFlameArenaLocator extends Projectile{
    public EntityBurningFlameArenaLocator(World worldIn, EntityLivingBase throwerIn, float damage) {
        super(worldIn, throwerIn, damage);
    }

    public EntityBurningFlameArenaLocator(World worldIn) {
        super(worldIn);
    ...
    public EntityBurningFlameArenaLocator(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
