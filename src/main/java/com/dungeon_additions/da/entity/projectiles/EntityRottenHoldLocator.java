...
public class EntityRottenHoldLocator extends Projectile{
    public EntityRottenHoldLocator(World worldIn, EntityLivingBase throwerIn, float damage) {
        super(worldIn, throwerIn, damage);
    }

    public EntityRottenHoldLocator(World worldIn) {
        super(worldIn);
    ...
    public EntityRottenHoldLocator(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
    ...
    protected void spawnParticles() {
        ...
        ParticleManager.spawnDust(this.world, particlePos, ModColors.GREEN, Vec3d.ZERO, ModRand.range(5, 10));
    }
