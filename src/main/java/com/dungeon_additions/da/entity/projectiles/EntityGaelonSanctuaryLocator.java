...
public class EntityGaelonSanctuaryLocator extends Projectile{

    public EntityGaelonSanctuaryLocator(World worldIn, EntityLivingBase throwerIn, float damage) {
        super(worldIn, throwerIn, damage);
    }

    public EntityGaelonSanctuaryLocator(World worldIn) {
        super(worldIn);
    ...
    public EntityGaelonSanctuaryLocator(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
