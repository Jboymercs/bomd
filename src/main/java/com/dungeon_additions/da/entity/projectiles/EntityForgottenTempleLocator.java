...
public class EntityForgottenTempleLocator extends Projectile{

    public EntityForgottenTempleLocator(World worldIn, EntityLivingBase throwerIn, float damage) {
        super(worldIn, throwerIn, damage);
    }

    public EntityForgottenTempleLocator(World worldIn) {
        super(worldIn);
    ...
    public EntityForgottenTempleLocator(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
