...
public class EntityObsidianLocator extends Projectile {


    public EntityObsidianLocator(World worldIn, EntityLivingBase throwerIn, float damage) {
        super(worldIn, throwerIn, damage);
    }

    public EntityObsidianLocator(World worldIn) {
        super(worldIn);
    ...
    public EntityObsidianLocator(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
    ...
    protected void spawnParticles() {
        ...
        ParticleManager.spawnDust(this.world, particlePos, ModColors.LIGHT_PURPLE, Vec3d.ZERO, ModRand.range(5, 10));
    }
