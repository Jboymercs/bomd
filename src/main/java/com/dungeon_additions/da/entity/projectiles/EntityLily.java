...
public class EntityLily extends Projectile{


    public EntityLily(World worldIn, EntityLivingBase throwerIn, float damage) {
    ...
    public EntityLily(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
    ...
    protected void spawnParticles() {
        ...
        ParticleManager.spawnColoredSmoke(this.world, particlePos, ModColors.YELLOW, new Vec3d(0, -0.1, 0));
    }
