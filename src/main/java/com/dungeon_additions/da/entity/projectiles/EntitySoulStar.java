...
public class EntitySoulStar extends Projectile {

    public EntitySoulStar(World worldIn, EntityLivingBase throwerIn, float damage) {
        super(worldIn, throwerIn, damage);
    }

    public EntitySoulStar(World worldIn) {
        super(worldIn);
    ...
    public EntitySoulStar(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.despawnTimer = 0;
        this.setSize(0.25F, 0.25F);
    ...
    public void onUpdate()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.despawnTimer > 80 && !this.world.isRemote)
            {
                ...
                {
                    this.world.spawnEntity(new EntityItem(this.world, this.posX, this.posY, this.posZ, new ItemStack(ModItems.SOUL_STAR)));
                }
                else
                {
