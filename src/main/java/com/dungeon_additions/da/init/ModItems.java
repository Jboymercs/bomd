...
public class ModItems {
    ...
    public static final Item FLAMES_RAGE_TRINKET = new ItemTrinket("flame_trinket","flame_trinket_desc", PotionTrinketConfig.flames_rage_durability, ItemTrinket.baubleSlot.AMULET);
    ...
    public static final Item HEART_TRINKET = new ItemTrinket("heart_trinket", "heart_trinket_desc", PotionTrinketConfig.vigorous_journey_durability, ItemTrinket.baubleSlot.AMULET);
