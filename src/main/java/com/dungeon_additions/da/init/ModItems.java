...
import com.dungeon_additions.da.items.armor.fallen.ItemFallenArmor;
import com.dungeon_additions.da.items.armor.fallen.ItemFallenChestplate;
import com.dungeon_additions.da.items.armor.fallen.ItemFallenHelmet;
...
public class ModItems {
    ...
    private static final Item.ToolMaterial KNIGHT_TRIDENT_MATERIAL = EnumHelper.addToolMaterial("knight_trident_material", 2, 1100, 3.0F, (float) ModConfig.trident_damage, 10);
    ...
    private static final ItemArmor.ArmorMaterial FALLEN_ARMOR = EnumHelper.addArmorMaterial("fallen", ModReference.MOD_ID + ":fallen", 45 * ModConfig.armor_durability_scaling, new int[]{3, 6,8,3}, 5, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.5F);
    ...
    private static final ItemArmor.ArmorMaterial VOIDIANT_ARMOR = EnumHelper.addArmorMaterial("voidiant", ModReference.MOD_ID + "obsidian", 60 * ModConfig.armor_durability_scaling , new int[]{4, 6, 7, 4}, 25, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3F);
    private static final ItemArmor.ArmorMaterial OBSIDIAN_HELMET_MAT = EnumHelper.addArmorMaterial("obsidian", ModReference.MOD_ID +":obsidian_gear", 70 * ModConfig.armor_durability_scaling, new int[] {4,7,9,4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 1.5F);
    private static final ItemArmor.ArmorMaterial FLOWER_HELMET_MAT = EnumHelper.addArmorMaterial("flower", ModReference.MOD_ID +":flower", 48 * ModConfig.armor_durability_scaling, new int[] {2,4,6,2}, 30, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1F);
    private static final ItemArmor.ArmorMaterial KINGS_HELMET_MAT = EnumHelper.addArmorMaterial("king", ModReference.MOD_ID +":king", 65 * ModConfig.armor_durability_scaling, new int[] {4,7,9,4}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 1.5F);
    public ModItems() {
    ...
    public static final Item FALLEN_INSIGNIA = new ItemCraftingMaterial("fallen_insignia", "crafting_material").setCreativeTab(DungeonAdditionsTab.ALL);
    ...
    public static final Item ASPECT_TEMPLATE = new ItemUniqueMaterial("aspect_template", "aspect_template_desc").setCreativeTab(DungeonAdditionsTab.ALL);
    ...
    public static final Item POTION_CLAIRVOYANCE = new ItemClairvoyance("aspect_potion", "aspect_potion_desc").setCreativeTab(DungeonAdditionsTab.ALL);
    ...
    public static final Item SPEED_BOOTS_TRINKET = new ItemTrinket("boots_trinket", "boots_trinket_desc", PotionTrinketConfig.speed_runner_durability, 1);
    public static final Item FLAMES_RAGE_TRINKET = new ItemTrinket("flame_trinket","flame_trinket_desc", PotionTrinketConfig.flames_rage_durability, 2);
    public static final Item DEATH_TRINKET = new ItemTrinket("death_trinket","death_trinket_desc", PotionTrinketConfig.deaths_prosper_durability, 0);
    public static final Item SHIELD_TRINKET = new ItemTrinket("shield_trinket", "shield_trinket_desc", PotionTrinketConfig.mythic_shield_durability, 2);
    public static final Item DIAMOND_SHIELD_TRINKET = new ItemTrinket("diamond_shield_trinket", "diamond_shield_trinket_desc", PotionTrinketConfig.exalted_shield_durability, 2);
    public static final Item CREEPER_TRINKET = new ItemTrinket("creeper_trinket","creeper_trinket_desc", PotionTrinketConfig.creepers_will_durability, 0);
    public static final Item MAGIC_CHARM_TRINKET = new ItemTrinket("charm_trinket", "charm_trinket_desc", PotionTrinketConfig.magic_charm_durability, 0);
    public static final Item FROZEN_SLAM_TRINKET = new ItemTrinket("slam_trinket", "slam_trinket_desc", PotionTrinketConfig.frozen_slam_durability, 1);
    public static final Item VAMPIRIC_TRINKET = new ItemTrinket("vampire_trinket", "vampire_trinket_desc", PotionTrinketConfig.vampiric_durability, 0);
    public static final Item HEART_TRINKET = new ItemTrinket("heart_trinket", "heart_trinket_desc", PotionTrinketConfig.vigorous_journey_durability, 2);
    public static final Item GAMBLE_TRINKET = new ItemTrinket("gamble_trinket", "gamble_trinket_desc", PotionTrinketConfig.chip_fortunate_durability, 0);
    public static final Item POISON_TRINKET = new ItemTrinket("poison_trinket", "poison_trinket_desc", PotionTrinketConfig.poison_touch_durability, 0);
    public static final Item VOID_TRINKET = new ItemTrinket("void_trinket","void_trinket_desc", PotionTrinketConfig.voids_item_durability, 0);
    public static final Item WIND_TRINKET = new ItemTrinket("wind_trinket", "wind_trinket_desc", PotionTrinketConfig.storm_calling_durability, 1, true);
    public static final Item WEAKNESS_TRINKET = new ItemTrinket("weakness_trinket", "weakness_trinket_desc", PotionTrinketConfig.spiral_vain_durability, 0);
    public static final Item VOID_HAND_TRINKET = new ItemTrinket("void_hand_trinket", "void_hand_trinket_desc", PotionTrinketConfig.cult_classic_durability, 0);
    public static final Item CONFETTI_TRINKET = new ItemTrinket("confetti_trinket", "confetti_trinket_desc", PotionTrinketConfig.party_starter_durability, 0);
    public static final Item STALWART_SUMMONER = new ItemTrinket("stalwart_summoner", "stalwart_summoner_desc", PotionTrinketConfig.stalwart_summoner_durability, 1);
    public static final Item GOLDEN_MARK_TRINKET = new ItemTrinket("golden_mark_trinket", "golden_mark_trinket_desc", PotionTrinketConfig.golden_mark_durability, 0);
    public static final Item SIGIL_TRINKET = new ItemTrinket("sigil_trinket", "sigil_trinket_desc", PotionTrinketConfig.golden_ritual_durability, 1, true);
    public static final Item MAGIC_BOOST_TRINKET = new ItemTrinket("magic_boost_trinket", "magic_boost_trinket_desc", PotionTrinketConfig.magic_reservoir_durability, 2);
    public static final Item ARROW_TRINKET = new ItemTrinket("arrow_trinket", "arrow_trinket_desc", PotionTrinketConfig.blood_stained_arrow_durability, 0);
    public static final Item VICTORY_TRINKET = new ItemTrinket("victory_trinket", "victory_trinket_desc", PotionTrinketConfig.victory_rush_durability, 0);
    public static final Item DAGGER_TRINKET = new ItemTrinket("dagger_trinket", "dagger_trinket_desc", PotionTrinketConfig.dagger_trinket_durability, 0);
    public static final Item TELEPORT_TRINKET = new ItemTrinket("teleport_trinket", "teleport_trinket_desc", PotionTrinketConfig.teleport_trinket_durability, 1, true);
    public static final Item DODGE_TRINKET = new ItemTrinket("dodge_trinket", "dodge_trinket_desc", PotionTrinketConfig.dodge_trinket_durability, 1, true);
    public static final Item ROTTEN_TRINKET = new ItemTrinket("rotten_trinket", "rotten_trinket_desc", PotionTrinketConfig.rotten_ring_durability, 1, true);
    public static final Item BLUE_TRINKET = new ItemTrinket("blue_trinket", "blue_trinket_desc", PotionTrinketConfig.blue_trinket_durability, 1, true);
    public static final Item FLAME_EXPLOSION_TRINKET = new ItemTrinket("flame_explosion_trinket", "flame_explosion_trinket_desc", PotionTrinketConfig.flame_explosion_trinket_durability, 1, true);
    public static final Item ENDERMEN_TRINKET = new ItemTrinket("endermen_trinket", "endermen_trinket_desc", PotionTrinketConfig.endermen_trinket_durability, 2);
    public static final Item MACE_TRINKET = new ItemTrinket("mace_trinket", "mace_trinket_desc", PotionTrinketConfig.mace_trinket_durability, 1, true);
    ...
    public static final Item ASPECT_MAGE = new ItemTrinket("aspect_mage", "aspect_mage_desc", PotionTrinketConfig.aspect_mage_durability, 3);
    public static final Item ASPECT_COLOSSAL = new ItemTrinket("aspect_colossal", "aspect_colossal_desc", PotionTrinketConfig.aspect_colossal_durability, 3);
    public static final Item ASPECT_DAGGER = new ItemTrinket("aspect_dagger", "aspect_dagger_desc", PotionTrinketConfig.aspect_dagger_durability, 3);
    public static final Item ASPECT_DUELIST = new ItemTrinket("aspect_duelist", "aspect_duelist_desc", PotionTrinketConfig.aspect_duelist_durability, 3);
    public static final Item ASPECT_BOW = new ItemTrinket("aspect_bow", "aspect_bow_desc", PotionTrinketConfig.aspect_bow_durability, 3);
    //
    ...
    public static final Item ROT_TRIDENT = new ItemStormvierTrident("stormvier_trident", KNIGHT_TRIDENT_MATERIAL, "stormvier_trident_desc").setCreativeTab(DungeonAdditionsTab.ALL);
    public static final Item ADVENTURE_SWORD = new ItemAdventureSword("adventure_sword", "adventure_sword_desc",ADVENTURE_SWORD_MAT).setCreativeTab(DungeonAdditionsTab.ALL);
    ...
    //Ranged & Magic
    public static final Item MAGE_STAFF = new ItemMageStaff("mage_staff", "mage_staff_desc", MAGE_STAFF_MAT).setCreativeTab(DungeonAdditionsTab.ALL);
    ...
    //Armor
    public static final ItemArmor FALLEN_HELMET = new ItemFallenHelmet("fallen_helmet", FALLEN_ARMOR, 1, EntityEquipmentSlot.HEAD, "fallen_helmet", "fallen_helmet_desc");
    public static final ItemArmor FALLEN_CHESTPLATE = new ItemFallenChestplate("fallen_chestplate", FALLEN_ARMOR, 1,EntityEquipmentSlot.CHEST, "fallen_chestplate", "fallen_armor_desc");
    public static final ItemArmor FALLEN_LEGGINGS = new ItemFallenArmor("fallen_leggings", FALLEN_ARMOR, 2, EntityEquipmentSlot.LEGS, "fallen", "fallen_armor_desc");
    public static final ItemArmor FALLEN_BOOTS = new ItemFallenArmor("fallen_boots", FALLEN_ARMOR, 1, EntityEquipmentSlot.FEET, "fallen", "fallen_armor_desc");
    ...
    public static final Item STORMVIER_TRIDENT = new ItemTridentProjectile("storm_trident");
    ...
    public static final Item POISON_CLOUD_PROJECTILE = new ItemBase("poison_cloud", null);
